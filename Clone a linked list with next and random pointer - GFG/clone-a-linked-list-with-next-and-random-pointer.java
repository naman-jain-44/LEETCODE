...
class Clone {
    ...
    Node copyList(Node head) {
        ...
        Node curr = head ;
        while(curr!=null){
            Node fwd = curr.next ;   // insert a node in between two nodes 
            Node connect = new Node(curr.data);
            curr.next = connect;
            connect.next = fwd;
            curr = fwd;
        }
        ...
        while(curr!=null){
            Node rand = curr.arb;
            if(rand!=null){            // than assign the random pointers with help of our newly created list 
        ...
        //now with help of new dummy node we will break out our needed list and return it 
        Node dummy = new Node(-1);
        Node prev = dummy ;
         curr = head;
        while(curr!=null){
            prev.next = curr.next;
            curr.next = curr.next.next;  //joining again the original list 
                prev = prev.next;
            curr = curr.next ;
        }
